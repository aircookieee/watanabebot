...
function createAnimeEmbed(result, sTime, mediaType = 'ANIME') {
    ...
    const embed = new discord_js_1.EmbedBuilder()
        ...
        .setURL(anilistURL)
        .setDescription(description.length > 600 ? description.slice(0, 597) + '...' : description)
        .setColor(color);
    if (coverImage) {
    ...
    const displayOrder = ['CURRENT', 'COMPLETED', 'PAUSED', 'DROPPED', 'PLANNING', 'NOT_ON_LIST'];
    let userScores = '';
...
//# sourceMappingURL=anilistHelper.js.map